...
export const googleAuthCallback = passport.authenticate("google", {
  failureRedirect: "https://skill-me-server-rose.vercel.app/login",
  session: false,
});
...
export const handleGoogleLoginCallback = asyncHandler(async (req, res) => {
  ...
  if (existingUser) {
    ...
    return res.redirect(`https://skill-me-server-rose.vercel.app/discover`);
  }
  ...
  return res.redirect("https://skill-me-server-rose.vercel.app/register");
});
