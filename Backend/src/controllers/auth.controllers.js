...
export const googleAuthCallback = passport.authenticate("google", {
  failureRedirect: "https://skill-me.vercel.app/login",
  session: false,
});
...
export const handleGoogleLoginCallback = asyncHandler(async (req, res) => {
  ...
  if (existingUser) {
    ...
    return res.redirect(`https://skill-me.vercel.app/discover`);
  }
  ...
  return res.redirect("https://skill-me.vercel.app/register");
});
